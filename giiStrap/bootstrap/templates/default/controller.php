...
?>
        ...
        public function actionGeneratePdf()
	{
           $session=new CHttpSession;
           $session->open();
		Yii::import('application.modules.admin.extensions.giiStrap.bootstrap.*');
		require_once Yii::app()->basePath . '\extensions\giiStrap\bootstrap\tcpdf\tcpdf.php';
		require_once Yii::app()->basePath . '\extensions\giiStrap\bootstrap\tcpdf\config\lang\eng.php';
